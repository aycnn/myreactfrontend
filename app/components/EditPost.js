    ...
    switch (action.type) {
      ...
      case "titleRules":
        if (!action.value.trim()) {
          ...
          draft.title.message = "Burası boş kalamaz!"
        }
        return
      case "bodyRules":
        if (!action.value.trim()) {
          draft.body.hasErrors = true
          draft.body.message = "Body alanı boş kalamaz!"
        }
        return
      case "notFound":
        draft.notFound = true
      ...
      try {
        ...
        if (response.data) {
          ...
          if (appState.user.username != response.data.author.username) {
            appDispatch({ type: "flashMessages", value: "You do not have permission to do that, idiot!" })
            props.history.push("/")
          }
        } else {
